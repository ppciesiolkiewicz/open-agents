...
export class UniswapService {
  ...
  private receiptToTransaction(
    ...
    return {
      ...
      fromAddress: (receipt.from ?? '0x0000000000000000000000000000000000000000') as string,
      toAddress: (receipt.to ?? '0x0000000000000000000000000000000000000000') as string,
      ...(tokenIn ? { tokenIn } : {}),
      ...(tokenOut ? { tokenOut } : {}),
